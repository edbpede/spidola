...
// The UniFFI binding wrapper plus coroutine/Flow adapters (end-to-end cancellation), the Keystore-backed secrets callback, and the tagged logcat sink (TECH_SPEC §7, §4.8).
//
